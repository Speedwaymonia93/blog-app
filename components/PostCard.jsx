...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-0  lg:p-8 pb-12 mb-8">
      ...
      <div className="block lg:felx text-center items-center justify-center mb-8 w-full">
      ...
      <p className="text-center text-lg text-gray-700 font-normal px-4 lg:px-20 mb-8">
        {language === "en" ? post.excerpt : post.localizations[0].excerpt}
      </p>
      ...
      <div className="text-center">
        <Link href={`/post/${post.url}`}>
          <span className="transition duration-500 ease transform hover:-translate-y-1 inline-block bg-blue-600 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">
            {language === "en" ? "Continue Reading" : "Czytaj dalej"}
          </span>
        </Link>
      </div>
    </div>
